...
class DesktopProfile extends StatefulWidget {
  const DesktopProfile({Key? key, required this.userModel, required this.refreshUI, required this.logOut}) : super(key: key);
  final UserModel userModel;
  final Function refreshUI;
  final Function logOut;

  @override
  _DesktopProfileState createState() => _DesktopProfileState();
}
                        ...
                        children: <Widget>[
                          Row(
                            children: [
                              ...
                              Expanded(child: Text("Your Profile", style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold),))
                            ],
                          ),
                          //row 1
                          Row(
